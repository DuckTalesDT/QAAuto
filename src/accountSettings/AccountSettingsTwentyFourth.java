...
public class AccountSettingsTwentyFourth extends Variables {
	...
	public void test() throws InterruptedException{
		...
		if (date_60.equals(accountPage.fieldDays.getAttribute("value")))
			System.out.println("AccountSettings Twenty-fourth test is pass");
			else
				System.out.println("AccountSettings Twenty-fourth test is false");
