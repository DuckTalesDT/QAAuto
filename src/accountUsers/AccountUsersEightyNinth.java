...
public class AccountUsersEightyNinth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//89-Редактирование данных пользователем с доступом "Редактирование" возможно
				...
				if (dataCeloe_1000.equals(udpPage.fieldIncome_5_1.getText()))
					if (dataCeloe_1000.equals(udpPage.fieldRashod_3_1.getText()))
						if(dataCeloe_1000.equals(udpPage.fieldOstatok.getAttribute("value")))
							System.out.println("AccountUsers Eighty-ninth test is pass");
							else
								System.out.println("AccountUsers Eighty-ninth test part №5 is false");
						else
							System.out.println("AccountUsers Eighty-ninth test part №4 is false");
					else
						System.out.println("AccountUsers Eighty-ninth test part №3 is false");
				}
				else
					System.out.println("AccountUsers Eighty-ninth test part №2 is false");
			else
				System.out.println("AccountUsers Eighty-ninth test part №1 is false");
