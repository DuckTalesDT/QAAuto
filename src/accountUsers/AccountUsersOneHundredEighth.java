...
public class AccountUsersOneHundredEighth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//108-Пользователь с паролем менне 6 символов не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers One hundred eighth test is pass");
			else
				System.out.println("AccountUsers One hundred eighth test is false");
