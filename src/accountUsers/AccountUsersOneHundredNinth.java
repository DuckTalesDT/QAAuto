...
public class AccountUsersOneHundredNinth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//109-Всплывает подсказка при создании пользователя с паролем менне 6 символов  
		...
		if (promptParolChangeSmaller.equals(usersPage.labelPromptIncorrectData.getText()))
			System.out.println("AccountUsers One hundred ninth test is pass");
			else
				System.out.println("AccountUsers One hundred ninth test is false");
