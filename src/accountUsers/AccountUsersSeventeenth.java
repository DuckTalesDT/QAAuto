...
public class AccountUsersSeventeenth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//17-Пользователь без заполнения графы "Повторите пароль" не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers Seventeenth test is pass");
			else
				System.out.println("AccountUsers Seventeenth test is false");
