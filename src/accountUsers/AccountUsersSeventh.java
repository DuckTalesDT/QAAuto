...
public class AccountUsersSeventh extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//7-Менеджер без заполнения графы "Повторите пароль" не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers Seventh test is pass");
			else
				System.out.println("AccountUsers Seventh test is false");
