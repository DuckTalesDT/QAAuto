...
public class AccountUsersSixth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//6-Менеджер без заполнения графы "Пароль" не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers Sixth test is pass");
			else
				System.out.println("AccountUsers Sixth test is false");
