...
public class AccountUsersThird extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//3-Менеджер без заполнения графы "Телефон" не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers Third test is pass");
			else
				System.out.println("AccountUsers Third test is false");
