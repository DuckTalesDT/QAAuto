...
public class AccountUsersThirteenth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//13-Пользователь без заполнения графы "Телефон" не создается
		...
		if (countUsers_1 == (usersPage.countUsers(driver)))
			System.out.println("AccountUsers Thirteenth test is pass");
			else
				System.out.println("AccountUsers Thirteenth test is false");
