...
public class AccountUsersThirtyThird extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//33-Менеджер с комментарием создается 
						...
						if (rolMen.equals(usersPage.labelRolFirst.getText()))
							if (userActivityYes.equals(usersPage.fieldActivityTable.getText()))
								...
								if (userComment.equals(usersPage.fieldComment.getText()))
									System.out.println("AccountUsers Thirty-third test is pass");
									else
										System.out.println("AccountUsers Thirty-third test part №7 is false");
								
								//Возвращаемся к списку пользователей
								usersPage.buttonBackDontCreate.click();
								}
								else
									System.out.println("AccountUsers Thirty-third test part №6 is false");
							else
								System.out.println("AccountUsers Thirty-third test part №5 is false");
						else
							System.out.println("AccountUsers Thirty-third test part №4 is false");
					else
						System.out.println("AccountUsers Thirty-third test part №3 is false");
				else
					System.out.println("AccountUsers Thirty-third test part №2 is false");
			else
				System.out.println("AccountUsers Thirty-third test part №1 is false");
