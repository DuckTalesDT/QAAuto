...
public class AccountUsersTwentyEighth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//28-Пользователь с функцией "СМС-авторизация" = Нет создается   
		...
		usersPage.fieldActivity.sendKeys(smsYes);
						...
						if (rolPol.equals(usersPage.labelRolFirst.getText()))
							if (userActivityYes.equals(usersPage.fieldActivityTable.getText()))
								...
								if (smsNo.equals(usersPage.fieldSms.getText()))
									System.out.println("AccountUsers Twenty-eighth test is pass");
									else
										System.out.println("AccountUsers Twenty-eighth test part №7 is false");
								
								//Возвращаемся к списку пользователей
								usersPage.buttonBackDontCreate.click();
								}
								else
									System.out.println("AccountUsers Twenty-eighth test part №6 is false");
							else
								System.out.println("AccountUsers Twenty-eighth test part №5 is false");
						else
							System.out.println("AccountUsers Twenty-eighth test part №4 is false");
					else
						System.out.println("AccountUsers Twenty-eighth test part №3 is false");
				else
					System.out.println("AccountUsers Twenty-eighth test part №2 is false");
			else
				System.out.println("AccountUsers Twenty-eighth test part №1 is false");
