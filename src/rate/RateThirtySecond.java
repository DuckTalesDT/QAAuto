...
public class RateThirtySecond extends Variables {
	...
	public void test() throws InterruptedException{
		//32-Соответствие предоставляемых услуг при изменении тарифного плана на "Cтандартный" с услугой "Управление денежными потоками"
		...
		//Устанавливаем тариф Стандартный c УДП
