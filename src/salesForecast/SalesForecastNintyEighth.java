...
public class SalesForecastNintyEighth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//98-Коэффициент сезонности меняет прогноз согласно своего значения 
		...
		if (data.equals(pvPage.fieldKoefficientSave.getText()))
			System.out.println("SalesForecast Ninty-eighth test is pass");
			else
				System.out.println("SalesForecast Ninty-eighth test is false");
