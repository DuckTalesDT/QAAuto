...
public class SalesForecastOneHundredFifteenth extends Variables {
	
	@Test
	public void test() throws InterruptedException{
		//115-Менеджер с доступом "Только чтение" может пользоваться разделом "Коэффициент сезонности"
		...
		if (data.equals(pvPage.fieldKoefficientSave.getText()))
			System.out.println("SalesForecast One hundred fifteenth test is pass");
			else
				System.out.println("SalesForecast One hundred fifteenth test is false");
